						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown active">
								...
								<ul class="dropdown-menu">
									<li class="nav-item active"><a class="nav-link" href="category.php">Shop
											Category</a></li>
					...
					<ul class="main-categories">
						<li class="main-nav-list"><a data-toggle="collapse" href="#fruitsVegetable"
								aria-expanded="false" aria-controls="fruitsVegetable"><span
									class="lnr lnr-arrow-right"></span>Types of Shoes<span
									class="number">(53)</span></a>
							<ul class="collapse" id="fruitsVegetable" data-toggle="collapse" aria-expanded="false"
								aria-controls="fruitsVegetable">
								<li class="main-nav-list child"><a href="#">Sports Shoe<span
											class="number">(13)</span></a></li>
								<li class="main-nav-list child"><a href="#">Boots<span class="number">(09)</span></a>
								</li>
								<li class="main-nav-list child"><a href="#">Formal Shoe<span
											class="number">(17)</span></a></li>
								<li class="main-nav-list child"><a href="#">Athletic Shoe<span
						...
						<form action="#">
							<ul>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="apple"
										name="brand"><label for="apple">Puma<span>(29)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="asus"
										name="brand"><label for="asus">addidas<span>(29)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="gionee"
										name="brand"><label for="gionee">Nike<span>(19)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="micromax"
										name="brand"><label for="micromax">Star pro<span>(19)</span></label></li>
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<div class="container py-5 ">
					<div class="row mt-3">
						...
						#Counting Items
						$check_shoe = mysqli_num_rows($fire) > 0;
						#Chekcing Item is there or not
						if ($check_shoe) {
							#For fetching all the details 
							while ($row = mysqli_fetch_array($fire)) {
								...
								<div class="col-md-4">
									<div class="card">
										<div class="cart-body">
											<img src="" class="card-img-top" alt="Shoe Img">
											<h4 class="card-title">
														
											</h4>
											<div class="price">
												<h6><?php echo "Rs " . $row['price']; ?></h6>
												<h6 class="l-through">Rs 1200.00</h6>
											</div>
											<p class="card-text" style='font-size:18px;color:black'>
								...
								<div class="col-lg-3 col-md-6">
									<form method="post" action="main_cart.php">
										<div class="single-product">
											<img  src="image/<?php echo $row['image']; ?>" height="250px" width="260px" alt="Shoe Img">
							...
							echo "Admin!! Please Add Products.";
						}
			...
			<div class="row justify-content-center">
				<div class="col-lg-6 text-center">
					<div class="section-title">
						...
						<p>Footwear refers to garments worn on the feet, which typically serves the purpose of
							protection against
							adversities of the environment such as wear from ground textures and temperature..</p>
					</div>
				</div>
			</div>
			<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								...
								<div class="desc">
									...
									<div class="price">
										<h6>Rs 599.00</h6>
										<h6 class="l-through">Rs 899.00</h6>
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								...
								<div class="desc">
									...
									<div class="price">
										<h6>Rs 699.00</h6>
										<h6 class="l-through">Rs 999.00</h6>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-related-product d-flex">
								...
								<div class="desc">
									...
									<div class="price">
										<h6>Rs 599.00</h6>
										<h6 class="l-through">Rs 799 .00</h6>
									</div>
								</div>
							</div>
						</div>
